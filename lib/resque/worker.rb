module Resque
  ...
  class Worker
    ...
    def started
      ...
      worker = mongo_workers.find(:worker => self.to_s).limit(1).first
    ...
    def started!
      ...
      mongo_workers.update_one({ :worker => self.to_s}, { '$set' => { :started => Time.now.to_s}})
    end
    ...
    def state
      ...
      mongo_workers.find(:worker => self.to_s).limit(1).first ? :working : :idle
    end
